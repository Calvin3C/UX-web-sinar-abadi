        ...
        <div class="container">
            <div class="auth-container">
                <div class="auth-header">
                    <h2 id="auth-title">{{ session('mode') === 'register' ? 'Registrasi Customer' : 'Login' }}</h2>
                    <p style="color:#cbd5e1; font-size:14px;">Login untuk mulai berbelanja</p>
                </div>
                ...
                <div class="auth-body">
                    ...
                    <div id="login-section">
                        <div class="role-tabs" id="auth-role-selector">
                            <div class="role-tab active" data-role="customer" onclick="switchRole('customer', this)">
                                Customer</div>
                    ...
                    <div id="register-section" style="display:none;">
                        <form method="POST" action="{{ route('register.process') }}">
                            ...
                            <div class="form-group">
                                <label class="form-label">Username</label>
                                <input type="text" name="username" class="form-input" placeholder="Buat username unik"
                                    required>
                            </div>

                            <div class="form-group mb-8">
                                <label class="form-label">Kata Sandi</label>
                                <input type="password" name="password" class="form-input" placeholder="Min. 3 karakter"
                                    required>
                            </div>

                            <button type="submit" class="btn btn-primary w-100" style="font-size:16px;">Daftar
                                Sekarang</button>
                        </form>
